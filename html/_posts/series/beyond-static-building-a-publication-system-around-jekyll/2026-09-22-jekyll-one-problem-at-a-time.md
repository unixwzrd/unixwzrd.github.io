---
short_link_basis: "/_posts/2026-09-22-jekyll-one-problem-at-a-time.md"
short_url: "https://unixwzrd.ai/s/16a984e171/"
layout: post
...
{% include blog_diagram.html
   src="/assets/images/blog/jekyll-site-tooling/post-01-project-flow.svg"
   alt="The authored YAML catalog feeds a project generator, which produces project data and a local card, conditionally scaffolds a landing page and blog directories, and supplies shared Liquid layouts for the project menu, projects page, and project blog."
   caption="One project definition reaches several views through generated data and shared templates."
   variant="series" %}
...
{% include blog_diagram.html
   src="/assets/images/blog/jekyll-site-tooling/post-01-url-identity.svg"
   alt="A project post's source file may move while its frozen publication date and permalink slug determine the canonical URL, its immutable short-link basis determines a redirect, and a declared legacy URL can redirect to that same canonical page."
   caption="For project posts, the source location, canonical URL, and short redirect have separate identities."
   variant="series" %}
