...
**If you or someone else is in crisis now, use [Emergency Resources](/resources/emergency-resources/).**
...
If you have a resource you would like added, [contact us](/contact).
...
- [Mental Health Resources](#mental-health-resources)
  ...
  - [United States Crisis and Support](#united-states-crisis-and-support)
  - [Finding Ongoing Care](#finding-ongoing-care)
  - [Evidence-Based Information](#evidence-based-information)
- [Legal Resources](#legal-resources)
  - [International and Cross-Border](#international-and-cross-border)
  - [United States Legal Resources](#united-states-legal-resources)
  - [Other Regional Legal Aid](#other-regional-legal-aid)
...
- [Eleven Labs](https://try.elevenlabs.io/mhtozfq2gzjo) - My preferred Speech to text for meetings, calls, and other audio transcription. Mac Whisper also does soem of this, but I prefer Eleven Labs for the quality and accuracy, plus it has amazing noise cancellation for elimination of background noise.
- [Mac Whisper](https://www.macwhisper.com) - Speech to text for macOS, all local, no Internet connection required. Uses additional local models or external services for enhancing quality, allows custom prompts for specific use cases. There's a free version and the paid Pro version with lifetime upgrades included for $75. License works with all Apple devices - iOS, iPadOS, and macOS. No subscription required. As much as I like Willow Voice, I use this product for dictation, coding, and more. Works with any app you can type in.
...
- [Parental Alienation Study Group](https://www.pasg.info) - Parental Alienation Study Group, Inc (PASG), is a nonprofit international organization of mental health professionals, legal professionals, targeted parents and grandparents, and child and family advocates who are interested in the study of parental alienation. You may become a member here here: [Become a PASG Member](https://www.pasg.info/membership/).
...
Legal services and eligibility vary by location. These directories provide information and referrals but are not substitutes for advice from a qualified lawyer in the relevant jurisdiction.
