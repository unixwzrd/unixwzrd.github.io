...
- ### How do you help with secrets and secure automation?
    ...
    We build workflows that avoid scattering API keys and tokens through `.env` files, shell history, command arguments, logs, and startup configs. [Secrets Kit](/projects/Secrets-Kit/) is one project in that area.

- ### How do I get a quote for your services?

    Reach out via the [Contact page](/contact/) with a short description of the system, data sensitivity, and desired outcome.
