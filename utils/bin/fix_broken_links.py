...
def find_broken_links() -> List[Dict]:
    ...
    broken_links = [
        ...
        },
        {
            ...
            'status': '403 - Forbidden',
            'files': ['html/projects/venvutil/_posts/2025-06-26-Venvutil-Summer-Update.md'],
            'issue': 'Blocked by robots.txt'
        },
        {
...
def main():
    parser = argparse.ArgumentParser(description='Fix broken links found in site monitoring')
    parser.add_argument('--dry-run', action='store_true', help='Show what would be fixed without making changes')
    parser.add_argument('--list-only', action='store_true', help='Only list broken links without fixing')
    ...
    # Group by issue type
    fixable_links = [link for link in broken_links if 'Wrong' in link['issue'] or 'URL' in link['issue'] or 'Site structure' in link['issue']]
    ...
    print(f"   These work correctly for human users but are blocked for automated testing.")
