...
class PermalinkValidator:
    ...
    def analyze_permalink(self, file_path: Path, permalink: str, title: str, content: str) -> Dict:
        ...
        if expected_base and permalink != expected_base:
            issue['problems'].append(f"Permalink '{permalink}' doesn't match expected '{expected_base}'")
    ...
    def get_expected_permalink_base(self, file_path: Path) -> str:
        ...
        if relative_path.name == "index.md":
            ...
            return "/404.html"
        elif relative_path.name in ["Policies.md", "General_Privacy.md", "General_ToS.md", "Privacy_LogGPT_for_Safari.md"]:
    ...
    def is_valid_internal_link(self, link: str) -> bool:
        ...
        valid_paths = [
            "/", "/about/", "/blog/", "/projects/", "/contact/", "/resources/",
            "/Policies/", "/Policies/General_Privacy/", "/Policies/General_ToS/",
            "/Policies/Privacy_LogGPT_for_Safari/", "/collaborate/", "/faq/",
            "/archive/", "/404.html",
            # Project paths
            "/projects/LogGPT/", "/projects/Case-Analytics/", "/projects/UnicodeFix/",
            "/projects/text-generation-webui-macos/", "/projects/oobabooga-macOS/",
            "/projects/TorchDevice/", "/projects/venvutil/"
        ]
